...
class schoolStore {
    ...
    @action getSingleSchool() {
        AlgoliaClient.initIndex("universities").getObject(this.schoolId).then(
    ...
    //     this.selectedSchool["2013-14 Net price"]
    ...
    //     if( !this.getTotalCost || !this.selectedMajor.Median){
    //         return null
    //     }

    //     else{
    //         this.getTotalCost / this.selectedMajor.Median
    //     } 

    // }

    //Algolia Search for North American Universities 
    @action searchUniversities(searchText) {
    ...
    @action searchMajors(searchText) {
