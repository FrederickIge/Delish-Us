                ...
                <div className="card rounded-0">
                  ...
                  <div className="card-body">
                    <form className="form" onSubmit={this.onSubmit}>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={event =>
                            this.setState(
                              this.byPropKey("email", event.target.value)
                            )
                          }
                          type="text"
                   ...
                   {!this.state.submitted && <button
                      ...
                      {this.state.submitted && <p className="text-success">Reset email sent! <Link className="text-dark return-link" to="login"> Return to Login Page</Link></p>}
