                      ...
                      <form>
                        <div className="form-row">
                          ...
                          <div className="col-12 col-md-6 mb-2 mb-md-0">
                                 ...
                                 <Link to="/signup"  className="btn btn-block btn-lg btn-primary" >Sign up!</Link> 
                             
                         
                          </div>

                          <div className="col-12 col-md-6">
                          <Link to="/login"  className="btn btn-block btn-lg btn-primary" >Login</Link>
                          </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-4">
                      <div className="features-icons-item mx-auto mb-0 mb-lg-3 p-3 mb-5 bg-white rounded hvr-grow-shadow">
                        ...
                        <p className="lead mb-0 text-default">
                          The world's most popular JS framework + starter kit
                        </p>
                      </div>
                    </div>
                  </div>
